...
-- WAP audit table: today's batch of team rolling stats for quality checks
-- before publishing to the incremental production table.
-- Reads from the published int_nba__team_game_stats with 30-day lookback
...
with team_stats as (
    ...
    where game_date >= current_date - 31
